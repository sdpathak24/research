...
def train(input_path):
    ...
    model_checkpoint = ModelCheckpoint('models/model1.keras', monitor='loss', verbose=1, save_best_only=True)
    # model.fit_generator(train_datagen, steps_per_epoch=1000, epochs=10, verbose=2, callbacks=[model_checkpoint])
    model.fit(train_datagen, steps_per_epoch=1000, epochs=10, verbose=2, callbacks=[model_checkpoint])
